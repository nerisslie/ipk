 ...
 * {@link IpkFragment.OnFragmentInteractionListener} interface
...
public class IpkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_ipk, container, false);

        predict_button = (Button) rootView.findViewById(R.id.predict_button);

        predict_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(rootView.getContext(), PredictActivity.class);
